{
51) Desarrolle un programa que permita generar un sorteo de la Quiniela (10 números de 3 cifras generados al
azar). Imprimir los números en el orden en que salieron sorteados. Permitir buscar un número sorteado.
}
